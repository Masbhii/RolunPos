<x-app-layout>
    <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">{{ $kode_kategori }}</h5>
                ...
                <form action="{{ route('kategori.store') }}" method="post">
                    ...
                    <div class="mb-0"><label for="deskripsi_kategori">Deskripsi kategori</label>
                        <textarea class="form-control form-control-solid" id="deskripsi_kategori" name="deskripsi_kategori" rows="3" placeholder="Contoh: Cita Rasa Amerikano">{{old('deskripsi')}}</textarea>
                    </div>    
                    <br>
                    <!-- untuk tombol simpan -->
